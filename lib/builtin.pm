...
Perl provides several utility functions in the C<builtin> package.

Functions in this package can be called by their fully-qualified names, but
it is often desired to give them shorter names for convenience. Individual
named functions can be imported by listing them as import parameters on the
C<use> statement for this pragma.
