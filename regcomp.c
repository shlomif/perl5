...
#define DEBUG_STUDYDATA(str, data, depth, is_inf)                    \
    ...
    U32 depth)
{
    ...
    params->frame = NULL;
#ifdef DEBUGGING
    params->re_debug_flags = re_debug_flags;
#endif
...
#define TRIE_TYPE(X) ( ( NOTHING == (X) ) ? NOTHING :   \
			    ...
			    U8 noper_next_trietype = (noper_next && noper_next != tail) ? TRIE_TYPE( noper_next_type ) :0;
                            ...
                            DEBUG_TRIE_COMPILE_r({
                                ...
                                PerlIO_printf( Perl_debug_log, "%*s- %s (%d)",
                                   (int)params->depth * 2 + 2,"", SvPV_nolen_const( RExC_mysv ), REG_NODE_NUM(cur) );
	    ...
	    continue;
            ...
            if (OP(params->scan) != SUSPEND) { /* GOSUB/GOSTART */
                /* Do setup, note this code has side effects beyond
                 * the rest of this block. Specifically setting
                 * RExC_recurse[] must happen at least once during
                 * study_chunk(). */
	        if (OP(params->scan) == GOSUB) {
                ...
                if (
                    ...
                    ||
                    (
                        (params->is_inf_internal || params->is_inf || params->data->flags & SF_IS_INF)
                        &&
	            ...
	            DEBUG_STUDYDATA("set:", params->data, params->depth, params->is_inf);
	            ...
	            DEBUG_STUDYDATA("inf:", params->data, params->depth, params->is_inf);
    ...
    (UV)(-counted * deltanext + (minnext + deltanext) * maxcount
		...
		case POSIXL:
                ...
                case NPOSIXA:   /* For these, we always know the exact set of
                    ...
                    /* FALLTHROUGH */
		case POSIXA:
                    if (FLAGS(params->scan) == _CC_ASCII) {
                ...
                *minnextp += params->min;
                ...
                if (params->data) {
                    ...
                    if ((params->flags & SCF_DO_SUBSTR) && params->data_fake.last_found) {
                        ...
                        if ( params->data_fake.minlen_fixed != params->minlenp )
                        {
                            params->data->offset_fixed= params->data_fake.offset_fixed;
                            params->data->minlen_fixed= params->data_fake.minlen_fixed;
                            params->data->lookbehind_fixed+= params->scan->flags;
                        }
                        if ( params->data_fake.minlen_float != params->minlenp )
                        {
                            params->data->minlen_float= params->data_fake.minlen_float;
                            params->data->offset_float_min=params->data_fake.offset_float_min;
                            params->data->offset_float_max=params->data_fake.offset_float_max;
                            params->data->lookbehind_float+= params->scan->flags;
                        }
                    }
                }
	    }
  ...
  finish:
    ...
    *params->deltap = params->is_inf_internal ? SSize_t_MAX : params->delta;
...

    {
        ...
        if (!(RExC_seen & REG_UNBOUNDED_QUANTIFIER_SEEN) && (RExC_maxlen < final_minlen + params->delta)) {
